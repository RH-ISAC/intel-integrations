...
curl -H "Authorization: Bearer $token" "https://api.trustar.co/api/1.3/indicators/search?from=$ago_24h&pageSize=1000&enclaveIds=59cd8570-5dce-4e5b-b09c-9807530a7086" > $filename
echo
